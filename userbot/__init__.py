...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/Xgrophy/Grovy-Userbot")
UPSTREAM_REPO_BRANCH = os.environ.get(
    "UPSTREAM_REPO_BRANCH", "Grovy-Userbot")
...
# Untuk Perintah .xalive
GROVY_TEKS_KUSTOM = os.environ.get(
    "GROVY_TEKS_KUSTOM",
    "I'am Using Grovy-Userbot✨")
...
# Bot Name
TERM_ALIAS = os.environ.get("TERM_ALIAS", "Grovy-Userbot")
...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO") or "https://telegra.ph/file/6eb4e56da6eacfd4d6eef.jpg"

# Default .helpme Logo
INLINE_PIC = os.environ.get(
    "INLINE_PIC") or "https://telegra.ph/file/6eb4e56da6eacfd4d6eef.jpg"

# Default emoji help
EMOJI_HELP = os.environ.get("EMOJI_HELP") or "⛑"

# °Grovy-Userbot°
OWNER_URL = os.environ.get("OWNER_URL") or "https://t.me/OpyRights"
...
async def checking():
    gocheck = str("@GrovySupport")
    checker = str("@GrovyUpdates")
    try:
...
with bot:
    try:
        ...
        LOGS.info(
            "Join Support Group @GrovySupport and Channel @GrovyUpdates to see the updates of userbot"
            "Don't Leave")
        quit(1)
...
async def update_restart_msg(chat_id, msg_id):
    ...
    message = (
        f"**Grovy-Userbot v{BOT_VER} is back up and running!**\n\n"
    ...
    try:
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid or event.query.user_id in SUDO_USERS:
                ...
                text = f"**⛑𝑮𝑹𝑶𝑽𝒀-𝑼𝑺𝑬𝑹𝑩𝑶𝑻⛑ ɪɴʟɪɴᴇ ᴍᴇɴᴜ⚡**\n\n✣ **ᴏᴡɴᴇʀ** [{user.first_name}](tg://user?id={user.id})\n✣ **ᴊᴜᴍʟᴀʜ** `{len(dugmeler)}` **Modules**"
                await event.edit(
                    text,
                    file=kyylogo,
                    buttons=buttons,
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith(
                ...
                result = builder.article(
                    title="Repository",
                    description="Repository Grovy-Userbot",
                    url="https://t.me/GrovySupport",
                    thumb=InputWebDocument(
                        INLINE_PIC,
                        0,
                        "image/jpeg",
                        []),
                    text="**⛑𝑮𝑹𝑶𝑽𝒀-𝑼𝑺𝑬𝑹𝑩𝑶𝑻⛑**\n➖➖➖➖➖➖➖➖➖➖\n✣ **ᴏᴡɴᴇʀ ʀᴇᴘᴏ :** [Opy](https://t.me/OpyRights)\n✣ **sᴜᴘᴘᴏʀᴛ :** @GrovySupport\n✣ **ʀᴇᴘᴏsɪᴛᴏʀʏ :** [Grovy-Userbot](https://github.com/Xgrophy/Grovy-Userbot)\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
                            custom.Button.url(
                                "ɢʀᴏᴜᴘ",
                                "https://t.me/GrovySupport"),
                            custom.Button.url(
                                "ʀᴇᴘᴏ",
                                "https://github.com/Xgrophy/Grovy-Userbot"),
                        ],
                ...
                result = builder.article(
                    title="⛑𝑮𝑹𝑶𝑽𝒀-𝑼𝑺𝑬𝑹𝑩𝑶𝑻⛑",
                    description="Grovy-Userbot | Telethon",
                    url="https://t.me/GrovyUpdates",
                    thumb=InputWebDocument(
                        INLINE_PIC,
                        0,
                        "image/jpeg",
                        []),
                    text=f"**⛑𝑮𝑹𝑶𝑽𝒀-𝑼𝑺𝑬𝑹𝑩𝑶𝑻⛑**\n➖➖➖➖➖➖➖➖➖➖\n✣ **ᴏᴡɴᴇʀ:** [{user.first_name}](tg://user?id={user.id})\n✣ **ᴀssɪsᴛᴀɴᴛ:** {tgbotusername}\n➖➖➖➖➖➖➖➖➖➖\n**ᴜᴘᴅᴀᴛᴇs:** @SkylaIND\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
                            custom.Button.url(
                                "ɢʀᴏᴜᴘ",
