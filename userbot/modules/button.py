...
from userbot.utils import edit_delete, grovy_cmd, reply_id
...
@grovy_cmd(pattern="button(?:\\s|$)([\\s\\S]*)")
async def _(event):
...
CMD_HELP.update(
    {
        ...
        \n  •  **Examples : **`{cmd}button test [google]<buttonurl:https://www.google.com> [Channel]<buttonurl:https://t.me/SkylaIND:same> [Support]<buttonurl:https://t.me/skylasupport>`\
    "
    }
)
