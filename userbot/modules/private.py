    ...
    if event.query.user_id == OWNER_ID:
        ...
        with io.BytesIO(str.encode(msg)) as fileuser:
            ...
            await tgbot.send_file(
                ...
                fileuser,
                force_document=True,
                thumb="resources/extras/IMG_20220324_151925_432.jpg",
    ...
    if chat.id != OWNER_ID:
        ...
        if customstrmsg is not None:
            ...
            start_msg = f"**👋 Hai** {mention}**!**\
                        ...
                        \n\n**Powered by** [UserBot](https://github.com/Xgrophy/Grovy-Userbot)"
            buttons = [
                (
...
async def infor(event):
    await tgbot.send_message(
        event.chat_id,
        message=f"**Groups**: [sᴜᴘᴘᴏʀᴛ](t.me/GrovySupport)\n**Github**: [Grovy-Userbot](https://github.com/Xgrophy/Grovy-Userbot)\n**Deploy**: [Heroku](https://dashboard.heroku.com/new?template=https%3A%2F%2Fgithub.com%2FXgrophy%2FGrovy-Userbot)",
        buttons=[
            [
                custom.Button.inline(
                    "ᴄʟᴏꜱᴇ",
